...
class DatasetCorrector:
    ...
    def run(self):
        ...
        manifest_rows = []
        with self.logger.progress_task("Correcting coordinates", len(discovered_files)) as (progress, task_id):
...
class DatasetAugmentor:
    ...
    def run(self):
        ...
        manifest_rows = []
        with self.logger.progress_task("Augmenting octants", len(discovered_files)) as (progress, task_id):
