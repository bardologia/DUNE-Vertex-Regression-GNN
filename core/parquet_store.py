...
from core.coordinate_correction import CoordinateTransform
...
class ParquetDatasetWriter:
    ...
    def read_all_events(self, discovered_files, geometry_hash):
        ...
        with self.logger.progress_task("Reading events into store", len(discovered_files)) as (progress, task_id):
    ...
    def report_sizes(self, octant_rows):
        ...
        self.logger.print_panel("Parquet Store Summary", {
